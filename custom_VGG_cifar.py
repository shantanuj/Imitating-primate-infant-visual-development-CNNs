###Model code for VGG growth (cifar)
import torch 
...
class CustomVGG(nn.Module):
    def __init__(self, new_block, prev_block=None, prev_model_classifier=None, num_output_classes=1000, init_weights=False):
        ...
        self.auxpool = nn.AdaptiveAvgPool2d((1, 1)) #Try maxpool OR 1,1 pooling
...
##removed last M for res<32 error and adaptive avgpool is used regardless
cfgs_custom = {
    'A': [[256, 'M'],  #8+3 =11
          [256, 'M'], 
          [256, 256, 'M'],
